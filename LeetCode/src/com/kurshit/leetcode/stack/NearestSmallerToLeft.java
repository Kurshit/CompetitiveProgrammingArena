...
public class NearestSmallerToLeft {
    ...
    public static void main(String[] args) {
        ...
        int[] arr = {11, 13, 21, 3};
        printNearestSmallerLeft(arr);
        printNearestSmallerLeftBF(arr);

        System.out.println();

        int[] arr1 = {1, 3, 2, 4};
        printNearestSmallerLeft(arr1);
        printNearestSmallerLeftBF(arr1);
    ...
    public static void printNearestSmallerLeft(int[] arr) {
    ...
    public static void printNearestSmallerLeftBF(int[] arr) {
